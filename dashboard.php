...
$categorySql = "SELECT * FROM categories WHERE categories_status = 1";
...
<div class="row">
	...
	<?php } ?>  
		...
		<div class="col-md-3 ">
			<div class="panel panel-info">
			<div class="panel-heading">
				<a href="categories.php?o=manord" style="text-decoration:none;color:black;">
					Total Category
					<span class="badge pull pull-right"><?php echo $countCategory; ?></span>
				</a>
