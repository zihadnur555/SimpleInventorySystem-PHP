		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    ...
			    <!-- <div class="col-sm-10">
			      <input type="text" class="form-control" value= "<?php echo date('d / m / Y'); ?>" disabled="Disabled" name="orderDate" autocomplete="off" />
			    </div> -->
				...
				<div class="col-sm-10" >
			      <input type="text" class="form-control" id="orderDate" name="orderDate"  autocomplete="off" value="<?php echo date('d / m / Y'); ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:15%;">Quantity <br></th>			  			
